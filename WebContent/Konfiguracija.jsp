		...
		$("#potvrdaButton").click( function(event) {
			  ...
			  $.post("${pageContext.request.contextPath}/RestoranMenadzerServlet",
					  ...
					  function(data, status) {
						  if(data == "true") {
					        	 alert("Postavljena je konfiguracija");
					        } else {
					        	alert("Doslo je do problema pri postavljanju konfiguracije.");
					        }
				})
		  });
...
<body>
	...
	<div class="container">
		...
		<div>
			<h3>Konfiguracija</h3>
           	<label>Broj stolova horizontano: </label>
           	<input type="text" id="brH">
           	<label>Broj stolova vertikalno</label>
           	<input type="text" id="brV">		
		</div>
